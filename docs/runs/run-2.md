...
| Mt Moon          | Paras           | Surge            |
| Cerulean City    | Sprigatito      | Surge            |
| Underground Path | Carnivine       | Surge            |
| Route 24         | Snubull         | Surge            |
| Route 25         | Taillow         | Surge            |
| Route 5          | Growlithe - H   | Surge            |
| Route 6          | Slowpoke - G    | Surge            |
| Vermillion City  | Staryu          | Surge            |
| SS Anne          | Wimpod          | Surge            |
| Route 11         | Bruxish         | Surge            |
| Diglett Cave     | Sandile         | Surge            |
| Route 9          | Egg - Squirtle  | Erika            |
| Route 10         | Helioptile      | Surge            |
| Rock Tunnel      | Cubone          | Surge            |
| Lavender Town    | Egg - Totodile  | Erika            |
| Route 12         | Seel            | Erika            |
| Route 8          | Egg - Sobble    | Erika            |
| Route 7          | Egg - Litten    | Erika            |
| Celadon City     | TBD - Dreepy    | Kanto Rematch    |
...
| ------------ | ------------------------------------- |
| Arcanine - H | Vikavolt                              |
| Clodsire     | Bellibolt & Toxic Spikes              |
| Donphan      | Manectric                             |
| Rapidash - G | Pawmot                                |
| Heliolisk    | Bonus, to bait Mud Shot from Vikavolt |
| Meganium     | Bellibolt/Pawmot/Pivot                |

- Nothing really to this one. Surge is super switch happy, but these mons wall him pretty hard. Vikavolt is really the only tricky one becauses of Levitate and the coverage. Lucked into an Hisuian Arcanine this run though, which makes it free with an Air Balloon.
